...
public class TravelController extends MObject {
     ...
     * invoke the interface in Route Service to get the route info of the traveller
     */
    @ResponseBody
    ...
    public MResponse getDetailInfo(@RequestParam("userId") String userId
        ...
        if (userId.equals("00001")){
            ...
            ResponseEntity<MResponse> responseResponseEntity =
                    restTemplate.exchange("http://routeservice/getRouteInfo",
                            HttpMethod.POST,httpEntity,MResponse.class);
